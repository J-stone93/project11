...
public class Ex4 {
	...
	public static void main(String[] args) {
		...
		System.out.println("ja라는 문자열을 시작하는지 확인하기: " + str.startsWith("ja"));
		System.out.println("ja라는 문자열을 끝나는지 확인하기: " + str.endsWith("va"));
		...
		System.out.println("2번위치부터 4번위치전까지 잘라 추출하기: " + str.substring(2, 4));
